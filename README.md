...
Quiebres de Stock e Inventario Fantasma: El taller de D&P constantemente se queda sin insumos críticos (como lijas o pintura) porque el sistema de la tienda no descuenta en tiempo real los materiales que los mecánicos retiran para las reparaciones. A su vez, se venden repuestos online que físicamente ya no están en bodega.

Caos en el Agendamiento y Operación: Los clientes reservan horas para reparaciones de motor, pero al llegar, descubren que los repuestos necesarios para su vehículo no fueron apartados previamente, retrasando todo el flujo del taller.

Falta de Trazabilidad del Cliente: No existe un historial unificado. Si un cliente compra repuestos de carrocería y agenda la reparación, el área de ventas y el taller manejan la información por separado, generando una pésima experiencia de usuario.
